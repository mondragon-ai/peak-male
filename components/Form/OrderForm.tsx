      ...
      <div className={`${styles.col} ${styles.formContainer}`}>
          <div>
            ...
            <div className={`${styles.col}`}>
              <Image src={"https://cdn.shopify.com/s/files/1/0697/5150/5204/files/2.png?v=1688574659"} width={350} height={450} alt="" style={{borderRadius: "6px", width: "100%", height: "auto"}} />
            ...
            <div className={`${styles.col} ${styles.productContainer}`}>
              <ProductRow title={"3 Wristbands/Decals"} price={2991} piece={"$9.97/coin"} variant_id={42555420606636} product_id={""} options1={""} options2={""} options3={""} state={state} setState={setState} />
              <ProductRow title={"5 Wristbands/Decals (SAVE 10%)"} price={4485} piece={"$8.97/coin"} variant_id={42555420639404} product_id={""} options1={""} options2={""} options3={""} state={state} setState={setState} />
              <ProductRow title={"10 Wristbands/Decals (SAVE 20%)"} price={7970} piece={"$7.97/coin"} variant_id={42555420672172} product_id={""} options1={""} options2={""} options3={""} state={state} setState={setState} />
              <ProductRow title={"20 Wristbands/Decals (SAVE 30%)"} price={13940} piece={"$6.97/coin"} variant_id={42555420704940} product_id={""} options1={""} options2={""} options3={""} best={true} state={state} setState={setState} />
            </div>
